...
#Version 5.1 See https://github.com/megamattzilla/iRules/tree/master/LTM_Server_Timings for more info. 
...
when HTTP_REQUEST priority 1000 {
    ...
    if { $st_http_request_count equals 1 } {
        ...
        if { $st_enableRemoteLog equals 1 and $st_triggerLogging equals 1 } { 
            HSL::send $st_hsl "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"False\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",cTCP=\"$st_a\",cTLS=\"$st_b\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",virtual_server=\"$st_virtual_server\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",statusCode=\"$st_iruleBlockResponseCode\",net.host.ip=\"$st_vip\",iRuleBlock=\"True\"" 
        } 
        
        if { $st_enableLocalLog equals 1 and $st_triggerLogging equals 1 } { 
            log local0. "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"False\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",cTCP=\"$st_a\",cTLS=\"$st_b\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",virtual_server=\"$st_virtual_server\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",statusCode=\"$st_iruleBlockResponseCode\",net.host.ip=\"$st_vip\",iRuleBlock=\"True\""
        } 
} else {
        #Only log request Level stats when this is not the first http Request in the TCP session 
        if { $st_enableRemoteLog equals 1 and $st_triggerLogging equals 1 } { 
            HSL::send $st_hsl "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"True\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",virtual_server=\"$st_virtual_server\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",statusCode=\"$st_iruleBlockResponseCode\",net.host.ip=\"$st_vip\",iRuleBlock=\"True\""
        }
        
        if { $st_enableLocalLog equals 1 and $st_triggerLogging equals 1 } { 
            log local0. "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"True\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",virtual_server=\"$st_virtual_server\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",statusCode=\"$st_iruleBlockResponseCode\",net.host.ip=\"$st_vip\",iRuleBlock=\"True\""
        }
        }
...
when ASM_REQUEST_BLOCKING {
    ...
    if { $st_http_request_count equals 1 } {
        ...
        if { $st_enableRemoteLog equals 1 and $st_triggerLogging equals 1 } { 
            HSL::send $st_hsl "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"False\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",cTCP=\"$st_a\",cTLS=\"$st_b\",f5Req=\"$st_c\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",virtual_server=\"$st_virtual_server\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",statusCode=\"$st_asmBlockResponseCode\",net.host.ip=\"$st_vip\",asmBlock=\"True\"" 
        } 
        
        if { $st_enableLocalLog equals 1 and $st_triggerLogging equals 1 } { 
            log local0. "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"False\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",cTCP=\"$st_a\",cTLS=\"$st_b\",f5Req=\"$st_c\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",virtual_server=\"$st_virtual_server\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",statusCode=\"$st_asmBlockResponseCode\",net.host.ip=\"$st_vip\",asmBlock=\"True\""
        } 
} else {
        set st_c [expr { $st_ASM_REQUEST_DONE - $st_HTTP_REQUEST } ] ; #measure time spent in F5 HTTP request processing time.
        ...
        #Only log request Level stats when this is not the first http Request in the TCP session 
        if { $st_enableRemoteLog equals 1 and $st_triggerLogging equals 1 } { 
            HSL::send $st_hsl "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"True\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",f5Req=\"$st_c\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",virtual_server=\"$st_virtual_server\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",statusCode=\"$st_asmBlockResponseCode\",net.host.ip=\"$st_vip\",asmBlock=\"True\""
        }
        
        if { $st_enableLocalLog equals 1 and $st_triggerLogging equals 1 } { 
            log local0. "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"True\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",f5Req=\"$st_c\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",virtual_server=\"$st_virtual_server\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",statusCode=\"$st_asmBlockResponseCode\",net.host.ip=\"$st_vip\",asmBlock=\"True\""
        }
        }
    #Clean up variables for next HTTP request incase there is TCP reuse. 
    #Dont edit these system Variables 
...
when HTTP_RESPONSE_RELEASE {
    ...
    if { $st_http_request_count equals 1 } {
        ...
        if { $st_enableRemoteLog equals 1 and $st_triggerLogging equals 1 } { 
            HSL::send $st_hsl "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"False\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",cTCP=\"$st_a\",cTLS=\"$st_b\",f5Req=\"$st_c\",sTCP=\"$st_d\",sTLS=\"$st_e\",poolRes=\"$st_f\",f5Res=\"$st_g\",overhead=\"$st_overhead\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",statusCode=\"$st_http_status\",http.response_content_length=\"$st_res_length\",virtual_server=\"$st_virtual_server\",pool=\"$st_pool\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",net.host.ip=\"$st_vip\"" 
        } 
        
        if { $st_enableLocalLog equals 1 and $st_triggerLogging equals 1 } { 
            log local0. "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"False\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",cTCP=\"$st_a\",cTLS=\"$st_b\",f5Req=\"$st_c\",sTCP=\"$st_d\",sTLS=\"$st_e\",poolRes=\"$st_f\",f5Res=\"$st_g\",overhead=\"$st_overhead\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",statusCode=\"$st_http_status\",http.response_content_length=\"$st_res_length\",virtual_server=\"$st_virtual_server\",pool=\"$st_pool\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",net.host.ip=\"$st_vip\"" 
        } 
} else {
        #Only log request Level stats when this is not the first http Request in the TCP session.
        set st_c [expr { $st_ASM_REQUEST_DONE - $st_HTTP_REQUEST } ] ; #measure time spent in F5 HTTP request processing time.
        ...
        if { $st_enableRemoteLog equals 1 and $st_triggerLogging equals 1 } { 
            HSL::send $st_hsl "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"True\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",f5Req=\"$st_c\",poolRes=\"$st_f\",f5Res=\"$st_g\",overhead=\"$st_overhead\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",http.status_code=\"$st_http_status\",http.response_content_length=\"$st_res_length\",virtual_server=\"$st_virtual_server\",pool=\"$st_pool\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",net.host.ip=\"$st_vip\"" 
        }
        
        if { $st_enableLocalLog equals 1 and $st_triggerLogging equals 1 } { 
            log local0. "hostname=\"$static::tcl_platform(machine)\",tcpID=\"$st_tcpID\",tcpReuse=\"True\",http.client_ip=\"[IP::client_addr]\",http.client_port=\"[TCP::client_port]\",f5Req=\"$st_c\",poolRes=\"$st_f\",f5Res=\"$st_g\",overhead=\"$st_overhead\",http.target=\"$st_http_uri\",http.host=\"$st_http_host\",http_method=\"$st_http_method\",http.request_content_length=\"$st_req_length\",statusCode=\"$st_http_status\",http.response_content_length=\"$st_res_length\",virtual_server=\"$st_virtual_server\",pool=\"$st_pool\",http.referrer=\"$st_http_referrer\",http.content_type=\"$st_http_content_type\",http.user_agent=\"$st_http_user_agent\",http.flavor=\"$st_http_version\",net.host.ip=\"$st_vip\"" 
        }
        }
